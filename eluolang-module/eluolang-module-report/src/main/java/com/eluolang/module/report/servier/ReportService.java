...
public interface ReportService {
     ...
     * @return
     */
    SchoolNumberVo selUserCount(Integer deptId, Integer optId);
     ...
     * @return
     */
    int selMeasuredNumber(Integer deptId, Integer optId,Integer year,Integer sex);
     ...
     * @return
     */
    EllEyesightParticulars selVisionByUserId(String userId, String date);
     ...
     * @return
     */
    EllBmiParticulars selBmiByUserId(String userId, String date);
     ...
     * @return
     */
    List<UserDailyResultVo> selUserTestResult(Integer deptId,Integer optId);
