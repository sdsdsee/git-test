...
public class DepartVo {
	...
	private List<DepartVo> treeList = new ArrayList<DepartVo>();
	 ...
	 *            生成树列表
	 */
	public static void genTreeByDg(List<DepartVo> src, List<DepartVo> dest) {

		List<DepartVo> pfdChild = new ArrayList<DepartVo>();
		for (DepartVo pfdd : dest) {
			for (DepartVo pfds : src) {
	 ...
	 *            生成树列表
	 */
	public static void genTreeByDg(List<DepartVo> src, List<DepartVo> dest,Map<Integer,DepartVo> leafMap) {
		
		List<DepartVo> dptChild = new ArrayList<DepartVo>();
		for (DepartVo dptd : dest) {
			for (DepartVo dpts : src) {
				// 输入的操作人id为所有数据中的父操作id
	...
	public List<DepartVo> getTreeList() {
		return treeList;
	}

	public void setTreeList(List<DepartVo> treeList) {
