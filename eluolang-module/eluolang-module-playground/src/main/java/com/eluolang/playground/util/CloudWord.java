...
public class CloudWord {
    public static void main(String[] args) {
        WordCloudHelper.wordCloud("中国共产党是中国工人阶级的先锋队，同时是中国人民和中华民族的先锋队，是中国特色社会主义事业的领导核心，代表中国先进生产力的发展要求，代表中国先进文化的前进方向，代表中国最广大人民的根本利益。党的最高理想和最终目标是实现共产主义。\n" +
                "\n" +
                ...
                "\n","E:\\EllTestImg\\111.png","E:\\EllTestImg\\7.png");
    }
}
