...
//                publishClient = new MqttClient(mqttConfig.getHost(), IdUtils.fastSimpleUUID(), new MemoryPersistence());
//            }
...
////                subsribeClient.subscribe("/upload/"+number+"/wristband/data",0);
////            }
////            String[] macList = mqttConfig.getDefault_topic().split(",");
////            for(int i = 0; i < macList.length; i++) {
////                Map<String, String> jsonMap = JSON.parseObject(macList[i], new TypeReference<HashMap<String, String>>() {});
////                init("/upload/"+jsonMap.get("productKey")+"/"+jsonMap.get("mac")+"/wristband/data",0);
////            }
//
//        } catch (Exception e) {
//            LOGGER.info(e.getMessage(), e);
