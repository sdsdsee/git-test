...
public class SendSmsHuaWei {
    ...
    private static String appKey = "x33e5A2G9kM7u1GtD6YRO47ihLxO"; //APP_Key
    private static String appSecret = "gfNXlnpnGMugzhC91Ob8R9qGg19t"; //APP_Secret
    private static String sender = "1069368924410001946"; //国内短信签名通道号或国际/港澳台短信通道号
    private static String templateId = "0c0d910dab40482c99445858d456481a"; //模板ID
    //条件必填,国内短信关注,当templateId指定的模板类型为通用模板时生效且必填,必须是已审核通过的,与模板类型一致的签名名称
    //国际/港澳台短信不用关注该参数
    private static String signature = "易洛朗验证码"; //签名名称

    public static void main(String[] args) throws Exception {
        sendMassage(sender, "18728418240", codeCreate());
        //codeCreate();
    }
     ...
     */
    static String sendMassage(String sender, String receiver, int code) throws Exception {
